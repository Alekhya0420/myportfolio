...
const Hero = () => {
  return (
    ...
    <div className='grid grid-cols-1 lg:grid-cols-2 items-center gap:12'>
        ...
        <div>
        <h1 className='text-2xl md:text-3xl lg:text-4xl mb-5 text-gray-300'>I am {BaseInfo.name}</h1>
        <h1 className='text-bg sm:text-4xl md:text-5xl lg:text-6xl xl:text-5xl md:leading-[3rem]
        xl:leading-[3.2rem] text-white xl:leading-[3.5rem]'>{BaseInfo.position}</h1>
        <p className='text-sm md:text-base  mt-5 text-white text-opacity-60'>{BaseInfo.description}</p>
